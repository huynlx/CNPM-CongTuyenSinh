    ...
    <div id="main">
        <div class="container">
            ...
            <div class="content">
                ...
                <input type="text" style="display:none;" id="ma_hsxt" name="ma_hsxt" value="<?php echo $ma_hsxt["ma_hsxt"]; ?>">
                <div class="form">
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
        ...
        <label><i class="fa fa-minus" aria-hidden="true"></i> Thêm nguyện vọng đăng ký</label>
                        ...
                        ?>
                                        ...
                                        <div class="col-sm-4 col-12">
                                            ...
                                            <input id="maxettuyen" type="text" ng-model="item.Aspiration.ProgramCode"
                    ...
                    ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-12">
                                            ...
                                            <input type="number" step="0.1" max="10" class="form-control"
                                ...
                                <div class="col-md-3 form-group pull-right">
                                    <button id="btnNguyenVong" name="ok" value="Lưu nguyện vọng"
                                        class="btn btn-primary btn-block">Lưu nguyện vọng</button>
                                </div>
                                </form>
    ...
    <div class="row" style="padding-top:30px">
        <div class="col-sm-12 col-12">
            ...
            <div class="col-sm-4 col-12 pull-right" ng-if="item.ProgressStep>=3">
                ...
                <a class="btn btn-block btn-primary btn-lg" style="display:none;" id = "btnHoanThanhHS" onclick="return confirm('Bạn có muốn hoàn thành hồ sơ không?');" href="<?php echo base_url();?>home/hoan_thanh_ho_so/<?php echo $ma_hsxt["ma_hsxt"]; ?>/<?php echo str_replace("@","-",$ts['email_ts']);?>">
