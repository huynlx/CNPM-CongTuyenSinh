<?php 
            //include( APPPATH.'views/site/home/header.php');
            //include( APPPATH.'views/site/home/nav-bot.php');
            //include( APPPATH.'views/site/xethocbaonline/main.php');
            //include( APPPATH.'views/site/home/footer.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="wrapper">
      ...
      <div class="search-mb">
            <div class="top_nav-mb">
                <input disabled="true" type="text" placeholder="Tìm kiếm">
                <span>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input disabled="true" readonly type="text" class="form-control" id="" required="required" name="ht"
                                    placeholder="Họ, chữ đệm và tên của thí sinh"
                                    value="<?php echo $ts['ho_ten_ts'] ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input disabled="true" disabled="true" type="date" name="ngaythangnamsinh" id="ngaythangnamsinh"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input disabled="true" disabled="true" type="text" class="form-control" name="socmnd" id=""
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input disabled="true" type="date" name="ngaycap" class="form-control"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input disabled="true" type="text" class="form-control" id="" name="noicap"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input disabled="true" type="text" class="form-control" name="phuongthixa" id=""
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input disabled="true" type="text" class="form-control" id="" name="thonbanduongpho"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input disabled="true" type="text" class="form-control" name="sdt" id=""
                                    placeholder="Điện thoại liên lạc" value="<?php echo $ts['sdt_ts']; ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" class="title__ip">Email:</label>
                                <input disabled="true" type="text" class="form-control" name="email" id="" placeholder="Email"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input disabled="true" type="text" class="form-control" id="" placeholder="Năm tốt nghiệp"
                            ...
                            <div class="form-group">
                                ...
                                <select disabled="true" id="input" name="khuvucuutien" class="form-control">
                                    ...
                                    <option value="KV2" <?php if ($ts['khu_vuc_uu_tien'] === "KV2")echo "selected";?>>
                                        KV2</option>
                                    <option value="KV2 - NT"
                                        <?php if ($ts['khu_vuc_uu_tien'] === "KV2 - NT")echo "selected";?>>KV2 - NT
                                    </option>
        ...
        <label><i class="fa fa-minus" aria-hidden="true"></i> Thêm nguyện vọng đăng ký</label>
                        ...
                        ?>
                                        ...
                                        <div class="col-sm-4 col-12">
                                            ...
                                            <input disabled="true" id="maxettuyen" type="text" ng-model="item.Aspiration.ProgramCode"
                                                class="form-control" placeholder="mã xét tuyển" required disabled
                                                value="">
                    ...
                    ?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-12">
                                            <label>Lớp 10 :</label><span
                                                ng-bind-html="CombinSubjectByCode[0].SubjectCode" id="mon1"></span>
                                            <input disabled="true" type="number" step="0.1" max="10" class="form-control"
                                                ng-model="item.Aspiration.GPA10_1" id="GPA10_1"
                                                placeholder="Điểm trung bình cả năm môn 1 {{CombinSubjectByCode[0].SubjectCode}}"
                                                required ng-disabled="item.ProgressStep==4">
                                        </div>
                                        <div class="col-sm-4 col-12">
                                            <label>&nbsp;</label><span
                                                ng-bind-html="CombinSubjectByCode[1].SubjectCode " id="mon2"></span>
                                            <input disabled="true" type="number" step="0.1" max="10" class="form-control"
                                                ng-model="item.Aspiration.GPA10_2" id="GPA10_2"
                                                placeholder="Điểm trung bình cả năm môn 2 {{CombinSubjectByCode[1].SubjectCode}}"
                                                required ng-disabled="item.ProgressStep==4">
                                        </div>
                                        <div class="col-sm-4 col-12">
                                            <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[2].SubjectCode"
                                                id="mon3"></span>
                                            <input disabled="true" type="number" step="0.1" max="10" class="form-control"
                                                ng-model="item.Aspiration.GPA10_3" id="GPA10_3"
                                                placeholder="Điểm trung bình cả năm môn 3 {{CombinSubjectByCode[2].SubjectCode}}"
                                                required ng-disabled="item.ProgressStep==4">
                                        </div>
                                    </div>
                                    <!--Điểm lớp 11 THPT-->
                                    <div class="row">
                                        <div class="col-sm-4 col-12">
                                            <label>Lớp 11 :</label><span
                                                ng-bind-html="CombinSubjectByCode[0].SubjectCode" id="monlop111"></span>
                                            <input disabled="true" type="number" step="0.1" max="10" class="form-control"
                                                ng-model="item.Aspiration.GPA11_1" id="GPA11_1"
                                                placeholder="Điểm trung bình cả năm môn 1 {{CombinSubjectByCode[0].SubjectCode}}"
                                                required ng-disabled="item.ProgressStep==4">
                                        </div>
                                        <div class="col-sm-4 col-12">
                                            <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[1].SubjectCode"
                                                id="monlop112"></span>
                                            <input disabled="true" type="number" step="0.1" max="10" class="form-control"
                                                ng-model="item.Aspiration.GPA11_2" id="GPA11_2"
                                                placeholder="Điểm trung bình cả năm môn 2 {{CombinSubjectByCode[1].SubjectCode}}"
                                                required ng-disabled="item.ProgressStep==4">
                                        </div>
                                        <div class="col-sm-4 col-12">
                                            <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[2].SubjectCode"
                                                id="monlop113"></span>
                                            <input disabled="true" type="number" step="0.1" min="0" max="10" class="form-control"
                                                ng-model="item.Aspiration.GPA11_3" id="GPA11_3"
                                                placeholder="Điểm trung bình cả năm môn 3 {{CombinSubjectByCode[2].SubjectCode}}"
                                                required ng-disabled="item.ProgressStep==4">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-12">
                                            <label>Lớp 12 :</label><span
                                                ng-bind-html="CombinSubjectByCode[0].SubjectCode" id="monlop121"></span>
                                            <input disabled="true" type="number" step="0.1" max="10" class="form-control"
                                                ng-model="item.Aspiration.GPA12_1" id="GPA12_1"
                                                placeholder="Điểm trung bình cả năm môn 1 {{CombinSubjectByCode[0].SubjectCode}}"
                                                required ng-disabled="item.ProgressStep==4">
                                        </div>
                                        <div class="col-sm-4 col-12">
                                            <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[1].SubjectCode"
                                                id="monlop122"></span>
                                            <input disabled="true" type="number" step="0.1" max="10" class="form-control"
                                                ng-model="item.Aspiration.GPA12_2" id="GPA12_2"
                                                placeholder="Điểm trung bình cả năm môn 2 {{CombinSubjectByCode[1].SubjectCode}}"
                                                required ng-disabled="item.ProgressStep==4">
                                        </div>
                                        <div class="col-sm-4 col-12">
                                            <label>&nbsp;</label><span ng-bind-html="CombinSubjectByCode[2].SubjectCode"
                                                id="monlop123"></span>
                                            <input disabled="true" type="number" step="0.1" max="10" class="form-control"
                                                ng-model="item.Aspiration.GPA12_3" id="GPA12_3"
                                                placeholder="Điểm trung bình cả năm môn 3 {{CombinSubjectByCode[2].SubjectCode}}"
                                                required ng-disabled="item.ProgressStep==4">
                                        </div>
                                    </div>
                                        ...
                                        <div ng-show="ViewAttachForm" id="attachfile">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="padding-top: 30px;">
                                                    ...
                                                    <input disabled="true" type="file" id="fileAttach" ng-model="fileAttachs" ngf-select
